#!/bin/bash
#
# Train GraphFlix on 25% subsample with proper data leakage prevention
# 
# This script:
# 1. Creates 25% subsample (if not exists)
...
echo "╔══════════════════════════════════════════════════════════════════════╗"
echo "║     GraphFlix Training on 25% Subsample (Data Leakage Prevention)    ║"
echo "╚══════════════════════════════════════════════════════════════════════╝"
echo ""
echo "This will:"
echo "  1. Create/verify 25% subsample with proper splits"
...
echo ""
echo "Expected time: ~1-2 days (vs 12 hours for 10%)"
echo "Expected performance: Better than 10% subsample"
echo ""
...
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "Step 1/6: Creating 25% subsample with proper splits..."
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""

if [ ! -d "$SUBSAMPLE_DIR" ]; then
    echo "Creating 25% subsample..."
    ...
    echo ""
    echo "✅ 25% subsample created"
else
    echo "✅ 25% subsample already exists at: $SUBSAMPLE_DIR"
fi
...
if [ ! -f "$SUBSAMPLE_DIR/graph_pyg.pt" ]; then
    echo "Building graph for 25% subsample..."
...
echo "  • Epochs: 20 (vs 5 before - for better convergence)"
echo "  • Learning rate: 0.001 (can tune later)"
echo "  • Dataset: 25% subsample (~1510 users, ~250K interactions)"
echo ""
...
RUN_NAME="graphflix_25pct_$(date +%Y%m%d_%H%M%S)"
...
echo ""
echo "Summary:"
echo "  • Dataset: 25% subsample (~250K interactions)"
echo "  • Training: 20 epochs (better convergence than 10%)"
...
echo ""
echo "Expected performance (vs 10%):"
echo "  10% subsample: Recall@10 = 0.101"
echo "  25% subsample: Recall@10 = 0.13-0.18 (expected improvement)"
echo "  Goal (LightGCN): Recall@10 = 0.18-0.22"
echo ""
echo "Next steps:"
echo "  1. Check if loss decreased properly (target: 0.3-0.5)"
echo "  2. Compare metrics with 10% baseline"
